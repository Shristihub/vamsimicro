...
//		return null;
	...
	public List<Product> getByProdNameHas(String name) throws ProductNotFoundException {
		return productRepository.findByProdNameWith("%"+name+"%");
	}
	...
	@Override
	public List<Product> getByCatBrand(String brand, String category) throws ProductNotFoundException {
		return productRepository.getByCatBrand(brand, category);
	}

	@Override
	public List<Product> getByPrice(double price) throws ProductNotFoundException {
